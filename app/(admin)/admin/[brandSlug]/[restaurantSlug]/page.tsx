    ...
    <main className="min-h-screen bg-[linear-gradient(160deg,#eef4ff_0%,#f8fbff_42%,#ffffff_100%)]">
      ...
      <div className="mx-auto max-w-6xl space-y-6 px-4 py-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-3xl font-bold text-[#0f1b35]">{displayBrandName} — {branchName}</h1>
            <p className="mt-2 text-sm text-[#58627f]">Panel del local con metrics, carta, mozos y reseñas.</p>
          </div>
          <div className="flex flex-wrap items-center gap-3">
            <Link
              href={`/admin/${brandSlug}`}
              className="inline-flex items-center gap-2 rounded-xl border border-[#d8e0ef] bg-white px-4 py-2 text-sm font-medium text-[#1c376f] transition hover:bg-[#f7f9ff]"
            >
        ...
        <section id="resumen" className="rounded-3xl border border-[#d8e0ef] bg-white p-6 shadow-[0_18px_45px_rgba(29,51,97,0.10)]">
          <div className="grid gap-6 xl:grid-cols-[1.3fr_0.9fr]">
            <div className="space-y-4">
              <div>
                <p className="text-xs uppercase tracking-[0.16em] text-[#6b7a99]">Resumen</p>
                <h2 className="mt-2 text-2xl font-bold text-[#122443]">Estado del local</h2>
        ...
        <section id="mozos" className="rounded-3xl border border-[#d8e0ef] bg-white p-6 shadow-[0_18px_45px_rgba(29,51,97,0.10)]">
          <div className="space-y-4">
            <div>

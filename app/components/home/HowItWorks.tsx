      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {steps.map((step, i) => (
            ...
            >
              <div
                className={`p-8 rounded-2xl bg-card border border-border hover:border-primary/30 transition-all hover:shadow-xl ${step.shadow} group-hover:-translate-y-1 duration-300`}
              >
                <div
                  className={`w-14 h-14 rounded-xl ${step.color} flex items-center justify-center mb-6 shadow-lg`}
                >

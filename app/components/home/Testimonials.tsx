...
const testimonials = [
  {
    name: "Roberto Méndez",
    role: "Dueño de La Parrilla del Sur",
    quote:
      "Ahora puedo ver cómo perciben mi restaurante en tiempo real. Detectamos problemas de espera y mejoramos la experiencia en pocas semanas.",
    initials: "RM",
  ...
  },
  {
    ...
    quote:
      "Es muy fácil calificar desde el QR. En segundos podés valorar la atención, la limpieza y el servicio. Se siente que tu opinión cuenta.",
    initials: "CT",
  ...
  },
  {
    ...
    quote:
      "La plataforma es súper intuitiva. Configuramos las métricas que queríamos evaluar y empezamos a recibir feedback útil desde el primer día.",
    initials: "MS",
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <Avatar className="w-11 h-11">
                  <AvatarFallback
                    className={`${t.gradient} text-primary-foreground font-bold text-sm`}
                  >
                    {t.initials}
                  </AvatarFallback>
                </Avatar>
